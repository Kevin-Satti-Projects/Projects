...
function showForm () {
    ...
    submit.addEventListener("click", function addBookToLibrary () {
        ...
        trashImage.addEventListener("click", function removeBookFromLibrary () {
            ...
            for(let i = ID; i <= document.getElementById("table").rows.length; i++){
...
document.getElementById("removeHobbit").addEventListener("click", function removeHobbitFromLibrary () {
